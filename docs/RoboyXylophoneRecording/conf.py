...
htmlhelp_basename = 'RoboyXylophoneRecordingdoc'
...
man_pages = [
    (master_doc, 'roboyxylophonerecording', 'RoboyXylophoneRecording Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RoboyXylophoneRecording', 'RoboyXylophoneRecording Documentation',
     author, 'RoboyXylophoneRecording', 'One line description of project.',
     'Miscellaneous'),
]